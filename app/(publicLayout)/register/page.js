    ...
    <section className="min-h-[80vh] flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 text-xl font-extrabold mb-6">
        ...
        <div className="bg-surface border border-border rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <label className="text-xs text-gray-400 font-bold tracking-wide">PROFILE PHOTO</label>
                <input
                  type="file"
                  accept="image/*"
                  onChange={handleImageChange}
                  className="w-full mt-2 text-xs text-gray-400 file:mr-3 file:py-2 file:px-3 file:rounded-lg file:border-0 file:bg-bg file:border file:border-border file:text-gray-300 file:text-xs"
                />
              </div>
            </div>

            <div>
              <label className="text-xs text-gray-400 font-bold tracking-wide">NAME</label>
              <input
                type="text"
                name="name"
                required
            ...
            <div>
              <label className="text-xs text-gray-400 font-bold tracking-wide">EMAIL</label>
              <input
                type="email"
                name="email"
                required
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg bg-lime text-bg font-bold hover:bg-limeDark transition disabled:opacity-50"
            >
          ...
          <button
            ...
            className="w-full py-3 rounded-lg bg-bg border border-border font-semibold text-sm flex items-center justify-center gap-3 hover:border-lime transition"
          >
